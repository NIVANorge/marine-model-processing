    ...
    <rasterrenderer nodataColor="" band="1" opacity="1" type="singlebandpseudocolor" alphaBand="-1" classificationMin="0.1" classificationMax="15.0">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" classificationMode="1" clip="0" minimumValue="0.1" maximumValue="15.0" labelPrecision="2">
          <item value="1.0" alpha="255" color="#E6B9D7" label="Single plants, ≤ 1"/>
          <item value="7.0" alpha="255" color="#B46496" label="Scarce, > 1, ≤ 7"/>
          <item value="15.0" alpha="255" color="#882255" label="Moderately dense, > 7, ≤ 15"/>
          <item value="1e+10" alpha="255" color="#44112B" label="Dense/full-cover forest, > 15"/>
