    ...
    <rasterrenderer nodataColor="" band="1" opacity="1" type="singlebandpseudocolor" alphaBand="-1" classificationMin="0.1" classificationMax="10.0">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" classificationMode="1" clip="0" minimumValue="0.1" maximumValue="10.0" labelPrecision="2">
          <item value="0.5" alpha="255" color="#C8E6D2" label="Single individuals, ≤ 0.5"/>
          <item value="5.0" alpha="255" color="#64AA78" label="Scarce occurrences, > 0.5, ≤ 5"/>
          <item value="10.0" alpha="255" color="#117733" label="Moderately dense kelp forest, > 5, ≤ 10"/>
          <item value="1e+10" alpha="255" color="#093C1A" label="Dense kelp forest, > 10"/>
